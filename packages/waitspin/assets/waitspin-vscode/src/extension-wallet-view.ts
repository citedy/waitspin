...
export const PUBLISHER_LEVELS_DOCS_LINK = `<a href="${PUBLISHER_LEVELS_DOCS_URL}" rel="noopener noreferrer">User levels and limits</a>`;
...
function renderPayoutReasons(status: WalletStatus): string {
  ...
  if (
    ...
    reasons.push(
      "Account review: Payouts are paused while WaitSpin reviews risk signals.",
    );
  }
